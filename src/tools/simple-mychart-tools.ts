...
export const mcGetAllergiesTool = simpleMyChartTool(
  ...
  c => c.getAllergies(),
  { hint: 'table', columns: ['Allergen', 'Reaction', 'Severity'] },
);
...
export const mcGetCareTeamTool = simpleMyChartTool(
  ...
  c => c.getCareTeam(),
  { hint: 'table', columns: ['Provider', 'Specialty', 'Role', 'Contact'] },
);
...
export const mcGetFamilyTreeTool = simpleMyChartTool(
  ...
  c => c.getFamilyTree(),
  { hint: 'table', columns: ['Relation', 'Age', 'Conditions'] },
);
...
export const mcGetHealthIssuesTool = simpleMyChartTool(
  ...
  c => c.getHealthIssues(),
  { hint: 'table', columns: ['Condition', 'Date', 'Status'] },
);
...
export const mcGetImmunizationsTool = simpleMyChartTool(
  ...
  { hint: 'table', columns: ['Date', 'Vaccine', 'Administrator', 'Source'] },
);
...
export const mcGetMedicationsTool = simpleMyChartTool(
  ...
  c => c.getMedications(),
  { hint: 'table', columns: ['Medication', 'Dose', 'Frequency', 'Prescriber'] },
);
...
export const mcGetUpcomingOrdersTool = simpleMyChartTool(
  ...
  { hint: 'table', columns: ['Date', 'Order', 'Type', 'Provider', 'Status'] },
);
...
export const mcGetAppointmentRequestsTool = simpleMyChartTool(
  ...
  { hint: 'table', columns: ['Date', 'Type', 'Provider', 'Status'] },
);
...
export const mcGetProxyAccessListTool = simpleMyChartTool(
  ...
  { hint: 'table', columns: ['Patient', 'Relationship', 'Proxy ID'] },
);
