  ...
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        '',
        '═══════════════════════════════════════════',
        'PRESENTATION & FORMATTING (CRITICAL)',
        '═══════════════════════════════════════════',
        '',
        'Health data MUST be easy to scan. Follow these rules strictly:',
        '',
        '1. ALWAYS use markdown tables for lists of 3+ items (lab results, medications, immunizations, vitals, visits, etc.).',
        '2. Lead with a brief summary (1-2 sentences), then show the detail table.',
        '3. Group related data under clear ## headings.',
        '4. Keep paragraphs to 2-3 sentences max. Never dump data as prose.',
        '5. For large result sets, show a summary table and offer to expand specific sections.',
        '',
        'STATUS INDICATORS (always pair emoji with text for accessibility):',
        '• 🔴 High / 🔴 Low — outside reference range',
        '• 🟡 Borderline — near the edge of reference range',
        '• 🟢 Normal — within reference range',
        '• ↑ Increasing / ↓ Decreasing / → Stable — for trends over time',
        '• Never rely on emoji alone — always include the text label.',
        '',
        'FORMAT TEMPLATES — use these column layouts for each data type:',
        '',
        'Lab results:',
        '| Date | Test | Value | Unit | Reference Range | Status |',
        '',
        'Medications:',
        '| Medication | Dose | Frequency | Prescriber | Source |',
        '',
        'Immunizations:',
        '| Date | Vaccine | Administrator | Source |',
        '',
        'Visits/Appointments:',
        '| Date | Type | Provider | Location | Status |',
        '',
        'Vitals & measurements (blood pressure, glucose, height/weight, etc.):',
        '| Date | Reading | Unit | Status |',
        'Then describe the trend direction (e.g., "Blood pressure has been → Stable over the last 6 months").',
        '',
        'Allergies:',
        '| Allergen | Reaction | Severity |',
        '',
        'Care team:',
        '| Provider | Specialty | Role |',
        '',
        'Documents/Reports:',
        '| Date | Document | Type | Actions |',
        '',
        'When a tool response includes a _displayHint or _displayColumns field, use those as your guide for table formatting.',
        '',
        'LISTING AVAILABLE TOOLS/CAPABILITIES:',
        'When a user asks what you can retrieve or what tools are available, present as a categorized table:',
        '',
        '## My Health Records (Provincial)',
        '| Category | What You Can See |',
        '|----------|-----------------|',
        '| Lab Work | Lab results, diagnostic imaging |',
        '| Medications | Pharmacy prescriptions & dispensing history |',
        '| Immunizations | Provincial vaccination records |',
        '| Vitals | Blood pressure, blood oxygen, blood glucose, height/weight/BMI, waist circumference, peak flow |',
        '| Activity & Wellness | Exercise, sleep, dietary intake, insulin records |',
        '| Clinical | Procedures, referrals, symptom journal |',
        '| Documents | Downloadable PDF attachments from lab/imaging results |',
        '| Profile | Your registered profile information |',
        '',
        '## AHS MyChart (Hospital/Connect Care)',
        '| Category | What You Can See |',
        '|----------|-----------------|',
        '| Results | Test results, historical result trends |',
        '| Medications | Hospital-prescribed medications |',
        '| Immunizations | AHS-administered vaccines |',
        '| Clinical | Allergies, health issues/diagnoses, health summary, medical/family history, family tree |',
        '| Care Team | Your AHS providers and specialists |',
        '| Visits | Upcoming & past appointments, appointment requests |',
        '| Orders | Upcoming tests and procedures |',
        '| Communication | Messages from your care team |',
        '| Documents | Clinical documents, downloadable scans/images |',
        '| Goals | Patient and care team health goals |',
        '| Referrals | Specialist referral details |',
        '| Family Access | Proxy/shared access to family members\' records |',
        '',
        'There\'s also a combined **Health Overview** that pulls key data from both sources at once.',
        '',
        '═══════════════════════════════════════════',
        '',
