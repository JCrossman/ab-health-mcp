  ...
  const server = new McpServer(
    ...
    },
    {
      instructions: [
        ...
        '',
        '═══════════════════════════════════════════',
        'FORMATTING RULES (MANDATORY — follow these for EVERY response)',
        '═══════════════════════════════════════════',
        '',
        '• ALWAYS use markdown tables for ANY list of 3+ items. NEVER use comma-separated lists or paragraph format for data.',
        '• Lead with a 1-2 sentence summary, then show the detail table.',
        '• Group related data under clear ## headings.',
        '• Keep paragraphs to 2-3 sentences max.',
        '• Each tool response includes a FORMATTING directive — follow it exactly.',
        '',
        'STATUS INDICATORS (always pair emoji with text for screen reader accessibility):',
        '• 🔴 High / 🔴 Low — outside reference range',
        '• 🟡 Borderline — near edge of reference range',
        '• 🟢 Normal — within reference range',
        '• ↑ Increasing / ↓ Decreasing / → Stable — trends',
        '',
        'LISTING AVAILABLE TOOLS/CAPABILITIES — when a user asks what you can do, use this table:',
        '',
        '## My Health Records (Provincial)',
        '| Category | What You Can See |',
        '|----------|-----------------|',
        '| Lab Work | Lab results, diagnostic imaging reports |',
